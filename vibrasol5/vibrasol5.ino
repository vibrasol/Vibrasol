 ...
 * 3.  Output 13 - Vibrator motor (flat coin type, in contact with skin, 5V) - GND
 ...
 Last revision v.4_dual of Feb 19th 2014
...
#define SENSOR_PIN1  1             // Sensor #2 input pin
...
int p1 = 0;                          // variable to store the value coming from the sensor #2
